function love.conf(t)
    t.identity = "lesRoms"              -- The name of the save directory (string)
    ...
    t.window.x = 1920/2-1024/2          -- The x-coordinate of the window's position in the specified display (number)
    t.window.y = 1080/2-960/2           -- The y-coordinate of the window's position in the specified display (number)
